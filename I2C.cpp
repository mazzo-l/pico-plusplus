...
void I2C::write(uint8_t address, const uint8_t *src, size_t length, bool nostop) const {
    i2c_write_blocking(inst, address, src, length, nostop);
}

void I2C::read(uint8_t address, uint8_t *dst, size_t length, bool nostop) const {
